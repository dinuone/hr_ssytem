...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('jobs.index') }}" class="d-none d-sm-inline-block btn btn-dark shadow-sm"><i
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('jobs.store') }}" id="jobs">
            @csrf
